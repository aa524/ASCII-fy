...
public class ImageImporter {
	...
	public static void main(String[] args) throws Exception {
		//TODO: Use hard-coded values as a default
		//TODO: Refactor to another method
		File file = new File(ImageImporter.class.getResource("image.jpg").toURI());
		ImageImporter.toGrayscale(file);
		file = new File(ImageImporter.class.getResource("image_gray.jpg").toURI());
	...
	public static void toGrayscale(File image) throws IOException{
		...
		//Using the luminosity method to convert a color image to grayscale
